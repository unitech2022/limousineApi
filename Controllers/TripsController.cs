...
namespace LimousineApi.Controllers
{
    ...
    public class TripsController : Controller
    {
        ...
        [HttpPost]
        [Route("payMent_trip")]
        public async Task<ActionResult> PayMentTrip([FromForm] int tripId,[FromForm] int payment,[FromForm] string userId)
        {

            return Ok(await _repository.PaymentTrip(tripId,payment,userId));
        }
